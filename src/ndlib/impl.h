...
namespace laruen::ndlib {
    ...
    struct Impl {
        ...
        template <typename T>
        static T* inverse_divide_eq(T *data, const ArrayBase &base, T value) noexcept {
            NDIter iter(data, base);
        ...
        template <typename T, typename TR>
        static TR* inverse_divide(const T *lhs_data, const ArrayBase &lhs_base, TR value, TR *out_data, const ArrayBase &out_base) noexcept {
            NDIter lhs_iter(lhs_data, lhs_base);
            NDIter out_iter(out_data, out_base);
        ...
        template <typename T>
        static T* inverse_shl_eq(T *data, const ArrayBase &base, T value) noexcept {
            NDIter iter(data, base);
        ...
        template <typename T, typename TR>
        static TR* inverse_shl(const T *lhs_data, const ArrayBase &lhs_base, TR value, TR *out_data, const ArrayBase &out_base) noexcept {
            NDIter lhs_iter(lhs_data, lhs_base);
            NDIter out_iter(out_data, out_base);
        ...
        template <typename T>
        static T* inverse_shr_eq(T *data, const ArrayBase &base, T value) noexcept {
            NDIter iter(data, base);
        ...
        template <typename T, typename TR>
        static TR* inverse_shr(const T *lhs_data, const ArrayBase &lhs_base, TR value, TR *out_data, const ArrayBase &out_base) noexcept {
            NDIter lhs_iter(lhs_data, lhs_base);
            NDIter out_iter(out_data, out_base);
        ...
        template <typename T>
        static T* inverse_remainder_eq(T *data, const ArrayBase &base, T value) noexcept {
            NDIter iter(data, base);
        ...
        template <typename T, typename TR>
        static TR* inverse_remainder(const T *lhs_data, const ArrayBase &lhs_base, TR value, TR *out_data, const ArrayBase &out_base) noexcept {
            NDIter lhs_iter(lhs_data, lhs_base);
            NDIter out_iter(out_data, out_base);
