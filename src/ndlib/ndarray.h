...
namespace laruen::ndlib {
    ...
    template <typename T = float64_t, bool C = true> class NDArray : public ArrayBase {
        ...
        public:
            ...
            template <typename T1, bool C1, typename T2, bool C2>
            friend NDArray<T1, C1>& xor_assign_normal(NDArray<T1, C1> &lhs, const NDArray<T2, C2> &rhs);

            template <typename T1, bool C1, typename T2, bool C2>
            friend NDArray<T1, C1>& xor_assign_broadcast(NDArray<T1, C1> &lhs, const NDArray<T2, C2> &rhs);

            template <typename T1, bool C1, typename T2, bool C2>
            friend NDArray<T1, C1>& and_assign_normal(NDArray<T1, C1> &lhs, const NDArray<T2, C2> &rhs);
            ...
            template <typename T1, bool C1, typename T2, bool C2>
            friend NDArray<T1, C1>& shl_assign_normal(NDArray<T1, C1> &lhs, const NDArray<T2, C2> &rhs);

            template <typename T1, bool C1, typename T2, bool C2>
            friend NDArray<T1, C1>& shl_assign_broadcast(NDArray<T1, C1> &lhs, const NDArray<T2, C2> &rhs);

            template <typename T1, bool C1, typename T2, bool C2>
            friend NDArray<T1, C1>& shr_assign_normal(NDArray<T1, C1> &lhs, const NDArray<T2, C2> &rhs);

            template <typename T1, bool C1, typename T2, bool C2>
            friend NDArray<T1, C1>& shr_assign_broadcast(NDArray<T1, C1> &lhs, const NDArray<T2, C2> &rhs);

            template <typename T1, bool C1, typename T2, bool C2>
            friend NDArray<T1, C1>& remainder_assign_normal(NDArray<T1, C1> &lhs, const NDArray<T2, C2> &rhs);

            template <typename T1, bool C1, typename T2, bool C2>
            friend NDArray<T1, C1>& remainder_assign_broadcast(NDArray<T1, C1> &lhs, const NDArray<T2, C2> &rhs);
    };
